...
def get_crossref_fulltext(config, doi, save_stream):
    ...
    if crossref_member == '16':
        return get_aps_fulltext(metadata, save_stream)
    elif crossref_member == '78':
        return get_elsevier_fulltext(metadata, save_stream,
                                     apikey=config['publishers']['elsevier']['apikey'])
    elif crossref_member == '297':
        return get_springer_fulltext(metadata, save_stream)
